        ...
        <div>
          ...
          <div className="flex gap-5">
            <a href="https://www.instagram.com" target="_blank">
              <Image
                src="/instagram.png"
                alt="Instagram de Cuidarte"
                width={100}
                height={100}
                className="h-8 w-8 hover:scale-115 transition h-20 w-auto shrink-0 object-contain"
              />
            </a>
            <a href="https://www.facebook.com" target="_blank">
              <Image
                src="/facebook.png"
                alt="Facebook de Cuidarte"
                width={100}
                height={100}
                className="h-8 w-8 hover:scale-115 transition h-20 w-auto shrink-0 object-contain"
              />
        ...
        <div className="mx-auto max-w-7xl px-6 py-6 text-xs text-white/70 flex flex-col md:flex-row justify-between gap-2">
          <span>
            ...
            <span className="font-bold">
              <a href="www.gallosolutions.com">Gallo Solutions</a>
            </span>
          </span>
          <span>
            Desarrollo:{" "}
          ...
          <span>
            © {new Date().getFullYear()} Cuidarte — Todos los derechos
            reservados
          </span>
        </div>
      </div>
